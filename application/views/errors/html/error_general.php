        ...
        <div class="col-lg-12">
            <div class="centering text-center error-container">
                <div class="text-center">
                    <h2 class="without-margin">Не волнуйтесь. Это только <span class="text-danger"><big><?php echo $status_code; ?></big></span> ошибка.</h2>
                    <h4 class="text-danger"><?php echo $heading; ?></h4>
                </div>
                <div class="text-center">
                    <blockquote>
